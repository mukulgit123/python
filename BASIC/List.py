...
def main():
    ...
    try:
        ...
        #firstList[len(firstList)+2] = 56 - Commented section for creating exception.
        firstList.sort()
        print "Sorted List: " + str(firstList)
        popped = firstList.pop() #removes last element on the list or the one at mentioned index
        ...
        copiedList.sort()
        del copiedList[:] #Clear function doesn't run on Python2.7 but we can clear a list like this
